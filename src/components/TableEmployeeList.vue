...
const items = computed(() => mainStore.employee_list);
  ...
  <div>
    ...
    <div class="flex flex-col md:flex-row md:flex-wrap gap-4 p-4">
      ...
      <div class="flex gap-0  justify-start">
        <FormField>
          <FormControl v-model="text" :icon="mdiMagnify"  type="tel" placeholder="Search" />
          <BaseButton type="submit" :icon="mdiPlus" color="danger" class="w-fit text-sm h-9" label="Add Employee" />
        </FormField>
      </div>
    </div>
...
<th data-label="Phone Number">Phone Number</th>
  ...
  {{ itemslist.end_time }}
            ...
            <td class="before:hidden lg:w-1 whitespace-nowrap">
              <BaseButtons type="justify-start lg:justify-end" no-wrap>
                <BaseButton color=""  class="border border-gray-300 bg-white" small :icon="mdiPencil" />
