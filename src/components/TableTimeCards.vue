...
const items = computed(() => mainStore.time_cards);
      ...
      <table class="min-w-full">
        <thead class="bg-slate-100 border border-t-0 border-l-0 border-r-0 border-gray-300">
          <tr>
            ...
            <th data-label="Time Out">Time Out</th>
            <th data-label="Total Hours">Total Hours</th>
            <th data-label="Logged Hours">Logged Hours</th>
        ...
        <tbody>
          <tr v-for="itemslist in itemsPaginated" :key="itemslist.transaction_number">
            ...
            <td data-label="Total Hours">
              {{ itemslist.total_hours }}
            </td>
            <td data-label="Logged Hours">
              {{ itemslist.logged_hours }}
            </td>
