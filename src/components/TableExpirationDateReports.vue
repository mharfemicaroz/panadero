...
const items = computed(() => mainStore.expiration_date_reports);
    ...
    <div class=" overflow-x-auto border border-gray-300 bg-white rounded-md m-4 px-4 py-2">
      ...
      <table class="min-w-full">
        <thead class="bg-slate-100 border border-t-0 border-l-0 border-r-0 border-gray-300">
          <tr>
            <th data-label="Reference Purchase Order #">Reference Purchase Order #</th>
        ...
        <tbody>
          <tr v-for="itemslist in itemsPaginated" :key="itemslist.transaction_number">
            ...
            <td data-label="Reference Purchase Order #">
              {{ itemslist.reference_purchase_order }}
            </td>
            <td data-label="Warehouse">
              {{ itemslist.warehouse }}
            </td>
            <td data-label="Supplier Name">
              {{ itemslist.supplier_name }}
            </td>
            <td data-label="Date">
              {{ itemslist.date }}
            </td>
