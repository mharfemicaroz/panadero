...
const items = computed(() => mainStore.refund);
    ...
    <div class=" overflow-x-auto border border-gray-300 bg-white rounded-md m-4 px-4 py-2">
      ...
      <table class="min-w-full">
        <thead class="bg-slate-100 border border-t-0 border-l-0 border-r-0 border-gray-300">
          <tr>
            <th data-label="Transaction #">Transaction #</th>
<th data-label="Overrided By">Overrided By</th>
...
<td data-label="Overrided By">
  {{ itemslist.overrided_by }}
</td>
<td data-label="Date">
  {{ itemslist.date }}
</td>
