...
const items = computed(() => mainStore.reference_number_report);
...
<th data-label="Payment Types">Payment Types</th>
<th data-label="Payment Type Name">Payment Type Name</th>
<th data-label="Receipt Number">Receipt Number</th>
<th data-label="Reference Number">Reference Number</th>
